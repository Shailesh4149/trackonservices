...
<footer class="bg-card border-t border-border py-12">
  <div class="container">
    <div class="grid md:grid-cols-4 gap-8">
      ...
      <nav aria-label="Services"><h3 class="font-bold text-lg text-foreground mb-4">Our Services</h3><ul class="space-y-2 list-none p-0"><li><a href="/same-day-courier-andheri-west" class="text-muted-foreground hover:text-primary text-sm">Same Day Courier</a></li><li><a href="/express-courier-mumbai" class="text-muted-foreground hover:text-primary text-sm">Express Courier</a></li><li><a href="/pan-india-courier" class="text-muted-foreground hover:text-primary text-sm">Pan India Courier</a></li><li><a href="/international-courier-mumbai" class="text-muted-foreground hover:text-primary text-sm">International Courier</a></li><li><a href="/airport-courier-mumbai" class="text-muted-foreground hover:text-primary text-sm">Airport Courier</a></li></ul></nav>
